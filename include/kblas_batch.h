...
*/
    ...
    int kblasCgemm_batch( kblasHandle_t handle,
                          ...
                          const int m, const int n, const int k,
                          const cuFloatComplex alpha,
                          const cuFloatComplex** A_array, int lda,
                          const cuFloatComplex** B_array, int ldb,
                          const cuFloatComplex beta,
    ...
    int kblasZgemm_batch( kblasHandle_t handle,
                          ...
                          const int m, const int n, const int k,
                          const cuDoubleComplex alpha,
                          const cuDoubleComplex** A_array, int lda,
                          const cuDoubleComplex** B_array, int ldb,
                          const cuDoubleComplex beta,
...
*/
    ...
    int kblasCsyrk_batch( kblasHandle_t handle,
                          char uplo, char trans,
                          const int m, const int n,
                          const cuFloatComplex alpha, const cuFloatComplex** A_array, int lda,
                          const cuFloatComplex beta,        cuFloatComplex** B_array, int ldb,
                          int batchCount);
    ...
    int kblasZsyrk_batch( kblasHandle_t handle,
                          char uplo, char trans,
                          const int m, const int n,
                          const cuDoubleComplex alpha, const cuDoubleComplex** A_array, int lda,
                          const cuDoubleComplex beta,        cuDoubleComplex** B_array, int ldb,
                          int batchCount);
...
*/
    ...
    int kblasCtrmm_batch(kblasHandle_t handle,
                         ...
                         const cuFloatComplex alpha,
                         const cuFloatComplex** A_array, int lda,
                               cuFloatComplex** B_array, int ldb,
                        int batchCount);
    ...
    int kblasZtrmm_batch(kblasHandle_t handle,
                         ...
                         const cuDoubleComplex alpha,
                         const cuDoubleComplex** A_array, int lda,
                               cuDoubleComplex** B_array, int ldb,
                        int batchCount);
...
*/
    ...
    int kblasCpotrf_batch(kblasHandle_t handle,
                          char uplo,
                          const int n,
                          cuFloatComplex** A_array, int lda,
                          int batchCount,
                          int *info_array);
    ...
    int kblasZpotrf_batch(kblasHandle_t handle,
                          char uplo,
                          const int n,
                          cuDoubleComplex** A_array, int lda,
                          int batchCount,
                          int *info_array);
    //------------------------------------------------------------------------------
    // Strided
