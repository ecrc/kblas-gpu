...
*/
    ...
    int kblas_gemm_lr(kblasHandle_t handle,
                      ...
                      const cuFloatComplex* Au, int ldAu, const cuFloatComplex* Av, int ldAv, int kA,
                      const cuFloatComplex* Bu, int ldBu, const cuFloatComplex* Bv, int ldBv, int kB,
    ...
    int kblas_gemm_lr(kblasHandle_t handle,
                      ...
                      const cuDoubleComplex* Au, int ldAu, const cuDoubleComplex* Av, int ldAv, int kA,
                      const cuDoubleComplex* Bu, int ldBu, const cuDoubleComplex* Bv, int ldBv, int kB,
    ...
    int kblas_gemm_lr_batch( kblasHandle_t handle,
                              ...
                              const int M, const int N, const int K,
                              const cuFloatComplex alpha,
                              const cuFloatComplex** Au_array, int ldAu,
                              const cuFloatComplex** Av_array, int ldAv, int kA,
                              const cuFloatComplex** Bu_array, int ldBu,
                              const cuFloatComplex** Bv_array, int ldBv, int kB,
                              const cuFloatComplex beta,
                                    cuFloatComplex** C_array, int ldC,
                              int batchCount);
    /**
     * @brief TODO
     */
    int kblas_gemm_lr_batch( kblasHandle_t handle,
                              ...
                              const int M, const int N, const int K,
                              const cuDoubleComplex alpha,
                              const cuDoubleComplex** Au_array, int ldAu,
                              const cuDoubleComplex** Av_array, int ldAv, int kA,
                              const cuDoubleComplex** Bu_array, int ldBu,
                              const cuDoubleComplex** Bv_array, int ldBv, int kB,
                              const cuDoubleComplex beta,
                                    cuDoubleComplex** C_array, int ldC,
                              int batchCount);
    //@}
    ...
    int kblas_gemm_lr_batch( kblasHandle_t handle,
                              ...
                              const int M, const int N, const int K,
                              const cuFloatComplex alpha,
                              const cuFloatComplex* Au, int ldAu, long strideAu,
                              const cuFloatComplex* Av, int ldAv, long strideAv, int kA,
                              const cuFloatComplex* Bu, int ldBu, long strideBu,
                              const cuFloatComplex* Bv, int ldBv, long strideBv, int kB,
                              const cuFloatComplex beta,
    ...
    int kblas_gemm_lr_batch( kblasHandle_t handle,
                              ...
                              const int M, const int N, const int K,
                              const cuDoubleComplex alpha,
                              const cuDoubleComplex* Au, int ldAu, long strideAu,
                              const cuDoubleComplex* Av, int ldAv, long strideAv, int kA,
                              const cuDoubleComplex* Bu, int ldBu, long strideBu,
                              const cuDoubleComplex* Bv, int ldBv, long strideBv, int kB,
                              const cuDoubleComplex beta,
