                    ...
                    double* acc, TYPE* rk)
{
  ...
  hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_ACAf<TYPE>), dim3(grid), dim3(block), shared_size, handle->stream, m, n,
              A, lda,
              U, ldu,
              V, ldv,
              S,
                ...
                int batchCount)
{
  ...
  hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_ACAf_batch_U<TYPE, TYPE**>), dim3(grid), dim3(block), shared_size, handle->stream, m, n,
                                  A, lda, strideA,
                                  U, ldu, strideU,
                                  V, ldv, strideV,
                                  S, lds, strideS,
                ...
                int batchCount)
{
  ...
  hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_ACAf_batch_N<TYPE, TYPE**, int*>), dim3(grid), dim3(block), shared_size, handle->stream, m, n,
                                        A, lda, strideA,
                                        U, ldu, strideU,
                                        V, ldv, strideV,
                                        S, lds, strideS,
