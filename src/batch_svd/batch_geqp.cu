...
) 
{
	...
	hipStream_t stream = kblasGetStream(handle);
	
	switch(threads)
	{
		case  32: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr,  32, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case  64: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr,  64, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case  96: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr,  96, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 128: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 128, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 160: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 160, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 192: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 192, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 224: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 224, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 256: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 256, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 288: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 288, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 320: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 320, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 352: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 352, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 384: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 384, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 416: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 416, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 448: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 448, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 480: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 480, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;
		case 512: hipLaunchKernelGGL(HIP_KERNEL_NAME(batch_geqp2_kernel<T, T_ptr, I_ptr, 512, PANEL_WIDTH>), dim3(dimGrid), dim3(dimBlock), smem, stream, m, n, M_batch, ldm, stride, tau_batch, stride_tau, piv_batch, stride_piv, ranks, tol, num_ops); break;		
