...
/**
 * @file src/blas_l2/syhemv_offset_core.cuh
...
// simple way to reuse the mgpu kernel on a single gpu
#define ngpus   (1)
#define gpu_gid (0)
...
__global__ void
syhemvl_special_d_offset( 	int n, T alpha,
				    		T *A, int lda,
				    		T *x, int incx,
				    		T  beta,
				    		T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread>
__global__ void
syhemvl_special_nd_offset( int n, T alpha,
				    		T *A, int lda,
				    		T *x, int incx,
				    		T  beta,
				    		T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread>
__global__ void
syhemvl_generic_d_offset( int n, T alpha,
				    T *A, int lda,
				    T *x, int incx,
				    T  beta,
				    T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread >
__global__ void
syhemvl_generic_nd_offset( int n, T alpha,
                            T *A, int lda,
                            T *x, int incx,
                            T  beta,
                            T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread>
__global__ void
syhemvu_special_d_offset( 	int n, T alpha,
				    		T *A, int lda,
				    		T *x, int incx,
				    		T  beta,
				    		T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread>
__global__ void
syhemvu_generic_d_offset( int n, T alpha,
				    T *A, int lda,
				    T *x, int incx,
				    T  beta,
				    T *y, int incy,
...
template <class T, int syhemv_bs, int thread_x, int thread_y, int elements_per_thread>
__global__ void
syhemvu_special_nd_offset( int n, T alpha,
                           T *A, int lda,
                           T *x, int incx,
                           T  beta,
                           T *y, int incy,
...
__global__  void
syhemvu_generic_nd_offset(int n, T alpha,
                            T *A, int lda,
                        	T *x, int incx,
                        	T  beta,
                        	T *y, int incy,
							int n_mod_syhemv_bs,
							int nstripes, int offset_)
{
    const int tx   = threadIdx.x ;
    const int ty   = threadIdx.y ;
    const int td  = (thread_x * ty ) + tx;
