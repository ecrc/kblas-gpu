...
#define __KBLAS_PREC_DEF__
  ...
  #define cublasXtrsm               hipblasStrsm
  #define cublasXgemm               hipblasSgemm
  #define cublasXgeam               hipblasSgeam
  #define cublasXscal               hipblasSscal
  #define cublasXgemmBatched        hipblasSgemmBatched
  #define cublasXgemmStridedBatched hipblasSgemmStridedBatched
  ...
  #define cublasXtrsm               hipblasDtrsm
  #define cublasXgemm               hipblasDgemm
  #define cublasXgeam               hipblasDgeam
  #define cublasXscal               hipblasDscal
  #define cublasXgemmBatched        hipblasDgemmBatched
  #define cublasXgemmStridedBatched hipblasDgemmStridedBatched
  ...
  #define cublasXgemm               hipblasCgemm
  #define cublasXgeam               cublasCgeam
  #define cublasXscal               hipblasCscal
  #define cublasXgemmBatched        hipblasCgemmBatched
  #define cublasXgemmStridedBatched hipblasCgemmStridedBatched
  ...
  #define cublasXgemm               hipblasZgemm
  #define cublasXgeam               cublasZgeam
  #define cublasXscal               hipblasZscal
  #define cublasXgemmBatched        hipblasZgemmBatched
  #define cublasXgemmStridedBatched hipblasZgemmStridedBatched
