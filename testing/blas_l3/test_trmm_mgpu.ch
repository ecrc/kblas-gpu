...
hipblasStatus_t kblas_xtrmm_mgpu(hipblasHandle_t handle,
  ...
  return kblas_strmm_mgpu(handle,
...
hipblasStatus_t kblas_xtrmm_mgpu(hipblasHandle_t handle,
  ...
  return kblas_dtrmm_mgpu(handle,
                    side, uplo, trans, diag,
                    m, n,
                    alpha, A, lda,
                           B, ldb, ngpu);
...
hipblasStatus_t kblas_xtrmm_mgpu(hipblasHandle_t handle,
  ...
  return kblas_ctrmm_mgpu(handle,
                    side, uplo, trans, diag,
                    m, n,
                    alpha, A, lda,
                           B, ldb, ngpu);
...
hipblasStatus_t kblas_xtrmm_mgpu(hipblasHandle_t handle,
  ...
  return kblas_ztrmm_mgpu(handle,
                    side, uplo, trans, diag,
                    m, n,
                    alpha, A, lda,
                           B, ldb, ngpu);
