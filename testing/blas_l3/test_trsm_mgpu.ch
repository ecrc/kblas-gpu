...
/**
 * @file testing/blas_l3/test_trsm_mgpu.ch
...
hipblasStatus_t kblas_xtrsm_mgpu(hipblasHandle_t handle,
                                hipblasSideMode_t side, hipblasFillMode_t uplo,
                                hipblasOperation_t trans, hipblasDiagType_t diag,
                                int m, int n,
                                const float *alpha,
                                const float *A, int lda,
                                      float *B, int ldb, int ngpu){
  return kblas_strsm_mgpu(handle,
...
hipblasStatus_t kblas_xtrsm_mgpu(hipblasHandle_t handle,
                                ...
                                const double *A, int lda,
                                      double *B, int ldb, int ngpu){
  return kblas_dtrsm_mgpu(handle,
                          side, uplo, trans, diag,
                          m, n,
                          alpha, A, lda,
                                B, ldb, ngpu);
...
hipblasStatus_t kblas_xtrsm_mgpu(hipblasHandle_t handle,
                                ...
                                const hipComplex *A, int lda,
                                      hipComplex *B, int ldb, int ngpu){
  return kblas_ctrsm_mgpu(handle,
                          side, uplo, trans, diag,
                          m, n,
                          alpha, A, lda,
                                B, ldb, ngpu);
...
hipblasStatus_t kblas_xtrsm_mgpu(hipblasHandle_t handle,
                                ...
                                const hipDoubleComplex *A, int lda,
                                      hipDoubleComplex *B, int ldb, int ngpu){
  return kblas_ztrsm_mgpu(handle,
                          side, uplo, trans, diag,
                          m, n,
                          alpha, A, lda,
                                B, ldb, ngpu);
  ...
  for( int i = 0; i < opts.ntest; ++i ) {
    for( int iter = 0; iter < opts.niter; ++iter ) {
      ...
      if(opts.warmup){
        ...
        check_error( kblas_xtrsm_mgpu(cublas_handle,
                                      side, uplo, trans, diag,
                                      M, N,
                                      &alpha, h_A, lda,
                                              h_Rk, ldb,
