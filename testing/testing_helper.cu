...
template<class T>
void generateArrayOfPointersT(T* original_array, T** array_of_arrays, int stride, int num_arrays, hipStream_t stream)
{
...
extern "C" void generateDArrayOfPointers(double* original_array, double** array_of_arrays, int stride, int num_arrays, hipStream_t stream)
{ generateArrayOfPointersT<double>(original_array, array_of_arrays, stride, num_arrays, stream); }

extern "C" void generateSArrayOfPointers(float* original_array, float** array_of_arrays, int stride, int num_arrays, hipStream_t stream)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline T getMaxElementT(T* a, size_t elements, hipStream_t stream)
{
...
template<class T>
inline int getMinElementT(T* a, size_t elements, hipStream_t stream)
{
	return thrust::reduce(
		thrust::cuda::par.on(stream),
...
extern "C" int getMaxElement(int* a, size_t elements, hipStream_t stream)
{ return getMaxElementT<int>(a, elements, stream); }

extern "C" int getMinElement(int* a, size_t elements, hipStream_t stream)
...
struct GPU_Timer
{
  ...
  GPU_Timer(hipStream_t stream = 0)
  {
    init(stream);
  }

  void init(hipStream_t stream = 0)
  {
...
extern "C" GPU_Timer* newGPU_Timer(hipStream_t stream)
{
...
// Error helpers
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
extern "C" void gpuAssert(hipError_t code, const char *file, int line)
{
  if(code != hipSuccess)
  {
...
extern "C" void gpuCublasAssert(hipblasStatus_t code, const char *file, int line)
{
...
extern "C" void crand_matrix(long rows, long cols, hipFloatComplex* A, long LDA)
{
...
extern "C" void zrand_matrix(long rows, long cols, hipDoubleComplex* A, long LDA)
{
	// fill in the entire matrix with random values
	long i;
	long size_a = cols * LDA;
...
extern "C" void cmatrix_make_hpd(int N, hipFloatComplex* A, int lda)
{ matrix_make_hpd_complex<hipFloatComplex>(N, A, lda); }

extern "C" void zmatrix_make_hpd(int N, hipDoubleComplex* A, int lda)
{ matrix_make_hpd_complex<hipDoubleComplex>(N, A, lda); }
...
template<class T>
void fillArrayT(T* array, int num_entries, T val, hipStream_t stream)
{
...
extern "C" void fillGPUIntArray(int* array_vals, int value, int num_elements, hipStream_t stream)
{
	fillArrayT<int>(array_vals, num_elements, value, stream);
}

extern "C" void copyGPUPointerArray(void** originalPtrs, void** copyPtrs, int num_ptrs, hipStream_t stream)
{
	thrust::copy(
		thrust::cuda::par.on(stream),
...
extern "C" float cget_max_error(hipFloatComplex* ref, hipFloatComplex *res, int n, int inc)
{ return get_max_error_complex<float, hipFloatComplex>(ref, res, n, inc); }

double zget_max_error(hipDoubleComplex* ref, hipDoubleComplex *res, int n, int inc)
{ return get_max_error_complex<double, hipDoubleComplex>(ref, res, n, inc); }
...
extern "C" float cget_max_error_matrix(hipFloatComplex* ref, hipFloatComplex *res, long m, long n, long lda)
{ return get_max_error_matrix_complex<float, hipFloatComplex>(ref, res, m, n, lda); }

extern "C" double zget_max_error_matrix(hipDoubleComplex* ref, hipDoubleComplex *res, long m, long n, long lda)
{ return get_max_error_matrix_complex<double, hipDoubleComplex>(ref, res, m, n, lda); }
...
extern "C" int parse_opts(int argc, char** argv, kblas_opts *opts)
{
  ...
  // set device
  hipError_t ed = hipSetDevice( opts->devices[0] );
  if(ed != hipSuccess){
