...
void gpuCublasAssert(hipblasStatus_t code, const char *file, int line);
...
GPU_Timer_t newGPU_Timer(hipStream_t stream);
...
////////////////////////////////////////////////////////////
void generateDArrayOfPointers(double* original_array, double** array_of_arrays, int stride, int num_arrays, hipStream_t stream);
void generateSArrayOfPointers(float* original_array, float** array_of_arrays, int stride, int num_arrays, hipStream_t stream);
...
// Reductions 
int getMaxElement(int* a, size_t elements, hipStream_t stream);
int getMinElement(int* a, size_t elements, hipStream_t stream);
...
#define TESTING_MALLOC_DEV( ptr, T, size) check_error( hipMalloc( (void**)&ptr, (size)*sizeof(T) ) )
#define TESTING_MALLOC_PIN( ptr, T, size) check_error( hipHostMalloc ( (void**)&ptr, (size)*sizeof( T ), hipHostMallocPortable  ))

#define TESTING_FREE_CPU(ptr)	{ if( (ptr) ) free( (ptr) ); }
#define TESTING_FREE_DEV(ptr)	check_error( hipFree( (ptr) ) );
...
void crand_matrix(long rows, long cols, hipFloatComplex* A, long LDA);
void zrand_matrix(long rows, long cols, hipDoubleComplex* A, long LDA);

void smatrix_make_hpd(int N, float* A, int lda);
void dmatrix_make_hpd(int N, double* A, int lda);
void cmatrix_make_hpd(int N, hipFloatComplex* A, int lda);
void zmatrix_make_hpd(int N, hipDoubleComplex* A, int lda);
...
void fillGPUIntArray(int* array_vals, int value, int num_elements, hipStream_t stream);
void copyGPUPointerArray(void** originalPtrs, void** copyPtrs, int num_ptrs, hipStream_t stream);
...
float cget_max_error(hipFloatComplex* ref, hipFloatComplex *res, int n, int inc);
...
float cget_max_error_matrix(hipFloatComplex* ref, hipFloatComplex *res, long m, long n, long lda);
double zget_max_error_matrix(hipDoubleComplex* ref, hipDoubleComplex *res, long m, long n, long lda);
...
inline float Xabs(hipFloatComplex a){return get_magnitude<float,hipFloatComplex>(a);}
inline double Xabs(hipDoubleComplex a){return get_magnitude<double,hipDoubleComplex>(a);}
