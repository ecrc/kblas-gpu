...
// float cget_magnitude(hipFloatComplex a){ return sqrt(a.x * a.x + a.y * a.y); }

// double zget_magnitude(hipDoubleComplex a) { return sqrt(a.x * a.x + a.y * a.y); }
...
// {
//   int i;
//   float max_err = cget_magnitude( make_hipFloatComplex(0.0, 0) );
//   float err, m;
//   inc = abs(inc);
//   for(i = 0; i < n; i++)
//   {
//     err = cget_magnitude( make_hipFloatComplex(res[i * inc].x - ref[i * inc].x, res[i * inc].y - ref[i * inc].y) );
...
// {
//   int i;
//   double max_err = zget_magnitude( make_hipDoubleComplex(0.0, 0) );
//   double err, m;
//   inc = abs(inc);
//   for(i = 0; i < n; i++)
//   {
//     err = zget_magnitude( make_hipDoubleComplex(res[i * inc].x - ref[i * inc].x, res[i * inc].y - ref[i * inc].y) );
...
//     for(j = 0; j < n; j++)
//     {
//       err = cget_magnitude(make_hipFloatComplex(res[j * lda + i].x - ref[j * lda + i].x, res[j * lda + i].y - ref[j * lda + i].y));
...
//     for(j = 0; j < n; j++)
//     {
//       err = zget_magnitude(make_hipDoubleComplex(res[j * lda + i].x - ref[j * lda + i].x, res[j * lda + i].y - ref[j * lda + i].y));
...
// void Xrand_matrix(long rows, long cols, hipFloatComplex* A, long LDA){
//   crand_matrix(rows, cols, A, LDA);
// }

// void Xrand_matrix(long rows, long cols, hipDoubleComplex* A, long LDA){
...
// float Xget_max_error_matrix(hipFloatComplex* ref, hipFloatComplex *res, long m, long n, long lda){
//   return cget_max_error_matrix(ref, res, m, n, lda);
// }

// double Xget_max_error_matrix(hipDoubleComplex* ref, hipDoubleComplex *res, long m, long n, long lda){
